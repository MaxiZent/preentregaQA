...
from selenium.webdriver.common.by import By #Importamos la librería que permite controlar el navegador
import time 

driver = webdriver.Chrome ()
driver.implicitly_wait (5)         #Esperas implícitas: espera hasta 5s a que los elementos estén disponibles
